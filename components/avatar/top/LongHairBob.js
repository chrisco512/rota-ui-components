...
export default function LongHairBob({ children, hairColor, facialHairType, facialHairColor }) {
		...
		<g id="Top" strokeWidth="1" fillRule="evenodd">
			...
			<g id="Top/Long-Hair/Bob" mask={`url(#${mask1})`}>
				<g transform="translate(-1.000000, 0.000000)">
					<g id="Hair" strokeWidth="1" fillRule="evenodd" transform="translate(39.000000, 19.000000)">
