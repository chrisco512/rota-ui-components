...
export default function Avatar({
	...
	const [ avatarId ] = useState(nanoid);
			...
			<g id="Avataaar" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
				<g transform="translate(-825.000000, -1100.000000)" id="Avataaar/Circle">
					<g transform="translate(825.000000, 1100.000000)">
						...
						<g id="Mask" />
						<g id="Avataaar" strokeWidth="1" fillRule="evenodd" mask="url(#mask-4)">
							<g id="Body" transform="translate(32.000000, 36.000000)">
								<mask id={`mask-6-${avatarId}`} fill="white">
									<use xlinkHref="#path-5" />
								</mask>
								<use fill="#D0C6AC" xlinkHref="#path-5" />
								<Skin maskId={`mask-6-${avatarId}`} color={skinColor} />
								<path
