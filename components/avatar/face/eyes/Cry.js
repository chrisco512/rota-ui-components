export default function Cry() {
	return (
		<g id="Eyes/Cry-😢" transform="translate(0.000000, 8.000000)">
			<circle id="Eye" fillOpacity="0.599999964" fill="#000000" fillRule="evenodd" cx="30" cy="22" r="6" />
			<path
				...
				fillRule="nonzero"
			/>
			<circle id="Eye" fillOpacity="0.599999964" fill="#000000" fillRule="evenodd" cx="82" cy="22" r="6" />
		</g>
	);
}
