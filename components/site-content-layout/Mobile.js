import { Box, Stack, Flex, Text, useDisclosure, SlideFade } from '@chakra-ui/react';
import { FaTable, FaThList, FaListOl } from 'react-icons/fa';
	...
	return (
		...
		>
			...
			<Flex bg="outline.500" w="100%" h={12} flexShrink={0}>
				...
				<MobileNavButton text="Thread" icon={FaThList} onClick={toggleThreadPanel} isOpen={isOpenThreadPanel} />
				<MobileNavButton text="Queue" icon={FaListOl} onClick={toggleQueuePanel} isOpen={isOpenQueuePanel} />
			</Flex>
		</Stack>
	);
}
